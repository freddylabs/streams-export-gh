        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="flex items-center bg-white/10 backdrop-blur-sm border border-brand-gold/30 rounded-full px-4 md:px-5 py-1 md:py-1.5 w-fit shadow-lg">
              ...
              <span className="text-white text-[10px] sm:text-xs md:text-sm font-inter font-semibold tracking-wide uppercase">
                Direct from Ghana
              </span>
              <div className="ml-3 md:ml-4 flex space-x-1 md:space-x-1.5">
                <span className="w-2 h-2 md:w-3.5 md:h-3.5 rounded-full bg-brand-red"></span>
                <span className="w-2 h-2 md:w-3.5 md:h-3.5 rounded-full bg-brand-flagGold"></span>
                <span className="w-2 h-2 md:w-3.5 md:h-3.5 rounded-full bg-brand-green"></span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-poppins font-bold text-white leading-tight mb-4 drop-shadow-2xl"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-lg text-gray-200 font-inter max-w-2xl mb-6 md:mb-8 leading-relaxed drop-shadow-md mx-auto px-4"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 mb-6 md:mb-10"
          >
            <Link
              href="/quote"
              className="btn-shimmer flex items-center justify-center bg-brand-gold text-brand-brown font-bold text-sm md:text-base lg:text-lg px-6 py-3 md:px-8 md:py-4 rounded-full hover:bg-brand-orange hover:text-white transition-all transform hover:scale-105 shadow-xl"
            >
              Get a Quote
            ...
            <Link
              href="/products"
              className="flex items-center justify-center bg-black/20 backdrop-blur-sm border border-brand-gold/50 text-white font-bold text-sm md:text-base lg:text-lg px-6 py-3 md:px-8 md:py-4 rounded-full hover:bg-white/10 hover:border-brand-gold transition-all shadow-xl"
            >
              Explore Products
            </Link>
          </motion.div>
